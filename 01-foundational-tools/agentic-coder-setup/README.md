...
3. To use Claude APIs, navigate to [Model Garden](https://console.cloud.google.com/vertex-ai/publishers/anthropic/model-garden/claude-fable-5) (and enable Vertex AI APIs if it pops up). Look to Anthropic to choose a model like Fable 5, and fill out a nominal form to turn on the API (this enables data sharing for the model). 
...
> **Model versions:** Both Cline-on-Vertex (step 3) and the Claude Code CLI installed here use **Claude Fable 5** via the Vertex AI backend.
